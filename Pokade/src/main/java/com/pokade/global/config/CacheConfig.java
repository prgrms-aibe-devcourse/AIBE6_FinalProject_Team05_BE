...
public class CacheConfig implements CachingConfigurer {
    ...
    // PriceService.getRanking()/refreshRanking() - PriceRankingRefreshScheduler가 매일 새벽 4시에 갱신하므로
    ...
    private RedisCacheManager buildRedisCacheManager(RedisConnectionFactory connectionFactory) {
        ...
        return RedisCacheManager.builder(connectionFactory)
                ...
                .withCacheConfiguration(PRICE_RANKING_CACHE, defaultConfig.entryTtl(Duration.ofHours(48)))
                .build();
    }
